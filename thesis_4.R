...
prepare_all_users_task_data <- function(data) {
  data %>%
...
# Main Execution
all_users_task_data <- prepare_all_users_task_data(data_set)
use_welch_for_t_test <- perform_levenes_test(all_users_task_data)
perform_paired_t_test(all_users_task_data, use_welch_for_t_test)
calculate_task_correlation(all_users_task_data)
visualize_task_data(all_users_task_data)